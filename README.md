...
See [AGENTS.md](AGENTS.md) for the full Skills Library and Workflow Rules.

## Documentation

Full documentation is available in the [`docs/`](docs/) directory.

*   [**Guide**](docs/guide.md): The comprehensive user guide and examples tour.
*   [**Architecture**](docs/architecture.md): The architectural vision.
*   [**Reference**](docs/reference.md): Schema and Ontology definitions.
*   [**Internal**](docs/technical.md): Developer guide for Claude integration.
