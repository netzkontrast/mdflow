...
let _showFileSelectorWithPreview: typeof import("./ui/file-selector").showFileSelectorWithPreview | null = null;
let _loadHistory: typeof import("../features/history").loadHistory | null = null;
let _getFrecencyScore: typeof import("../features/history").getFrecencyScore | null = null;
...
async function getFileSelector() {
  if (!_showFileSelectorWithPreview) {
    const mod = await import("./ui/file-selector");
